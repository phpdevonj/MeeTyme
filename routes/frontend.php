...
Route::get('/login', [FrontendController::class, 'userLoginView'])->name('user.login');
Route::post('/user-login', [CustomerController::class, 'userLogin'])->name('user.user_login');
Route::get('/register', [FrontendController::class, 'userRegistrationView'])->name('user.register');
