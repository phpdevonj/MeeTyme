...
Route::post('validate-otp', [API\User\UserController::class, 'validateOtp']);
Route::post('check-unique-username', [API\User\UserController::class, 'checkUniqueUsername']);
Route::post('reset-password', [API\User\UserController::class, 'resetPassword']);
...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::post('user-addresses', [API\UserAddressController::class, 'store']);
    Route::get('user-addresses', [API\UserAddressController::class, 'index']);
    Route::put('user-addresses/{id}', [API\UserAddressController::class, 'update']);
    Route::delete('user-addresses/{id}', [API\UserAddressController::class, 'destroy']);

    Route::post('/create-ideal-payment', [API\StripePaymentController::class, 'createIdealPayment']);
});
// payment route
Route::post('/stripe/webhook', [API\StripePaymentController::class, 'handleWebhook']);
