...
class ProviderController extends Controller {
    ...
    public function index_data(DataTables $datatable, Request $request) {
        ...
        return $datatable->eloquent($query)
            ...
            ->addColumn('is_email_verified', function ($query) {
                return $query->is_email_verified ? 'Yes' : 'No';
            })
    ...
    public function show($id) {
        ...
        $providerPayout = ProviderPayout::where('provider_id', $id)->where('status', 'Pending')->sum('amount');
        $providerPayoutCompleted = ProviderPayout::where('provider_id', $id)->where('status', 'completed')->sum('amount');
        ...
        $providerData = [
            ...
            'providerTotEarning' => $providerPayout,
            'providerTotWithdrableAmt' => $providerTotEarning->provider_booking_sum_total_amount,
            'providerAlreadyWithdrawAmt' => $providerPayoutCompleted,
            'pendWithdrwan' => $providerPayoutCompleted - $providerPayout,
        ];
