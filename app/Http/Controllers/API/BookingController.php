...
class BookingController extends Controller
{
    ...
    public function bookingUpdate(Request $request) {
        ...
        if($data['status'] === 'completed'){
            ...
            // $providerEarning = ProviderPayoutModel::where('provider_id',$bookingdata->provider_id)->sum('amount');
            // $provider_earning = calculate_commission($bookingdata->total_amount,$provider_commission,$provider_type,'provider',$providerEarning);
