...
<div class="card-body p-0">
    ...
    <div class="pay-box">
        <div class="pay-method-details">
            ...
            <h5 class="c1 mb-2">{{__('messages.online')}}</h5>
                ...
                <table class="table-sm title-color align-right w-100">
                    <tbody>
                        ...
                        <tr class="grand-total">
                            ...
                            <td class="bk-value">
                                <h3>{{isset($bookingdata->bookingAddonService) ? getPriceFormat($subTotalWithTax+$addonTotalPrice) : getPriceFormat($subTotalWithTax)}}</h3>
                            </td>
                        </tr>
